...
class TripController extends Controller
{
    ...
    public function addTrip(Request $request)
    {
        ...
        try {
            ...
            $validatedData = $request->validate([
                ...
                'price_for_two' => 'nullable|numeric',
                'price_for_three_or_more' => 'nullable|numeric',
                'location' => 'nullable|string|max:255', // الموقع مطلوب
                'duration' => 'nullable|string|integer', // المدة بالأيام
                'group_accompanying_price' => 'nullable|numeric', // المدة بالأيام
                'available_dates' => 'nullable|string', // التواريخ المتاحة
            ]);
    ...
    {
        try {
            // استعلام الرحلات مع ضم جدول الخيارات الإضافية
            $query = Trip::with('additionalOptions');
            ...
            // استرجاع الرحلات مع الخيارات الإضافية
            $trips = $query->get();
    ...
    public function updateTripAndOptions(Request $request, $id)
    {
        ...
        try {
            ...
            $validatedTripData = $request->validate([
                ...
                'description' => 'sometimes|nullable|string',
                'additional_info' => 'sometimes|nullable|string',
                'group_accompanying_price' => 'sometimes|nullable|numeric',
            ]);
            ...
            $trip->group_accompanying_price = $validatedTripData['group_accompanying_price'] ?? $trip->group_accompanying_price;
